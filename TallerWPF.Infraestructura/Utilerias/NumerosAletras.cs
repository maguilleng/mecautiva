...
namespace TallerWPF.Infraestructura.Utilerias
{
    public sealed class NumerosAletras
    {
    ...
    public NumerosAletras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
    {
    ...
    {
        return NumerosAletras.ToCardinal(Numero, CultureInfo.CurrentCulture);
    }
